...
export default function HeroSlider({ slides }: Props) {
  ...
  return (
    <section className="relative overflow-hidden" aria-label="באנרים" aria-roledescription="קרוסלה">
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 md:left-4 md:translate-x-0 flex items-center gap-3 z-20">
        {/* Dots */}
        ...
        {/* Arrows - RTL: right arrow = prev, left arrow = next */}
        <button
          onClick={goPrev}
