        ...
        <div className="max-w-2xl mx-auto px-4 text-center">
          <div className="bg-white/10 rounded-2xl p-10">
            ...
            <button
              ...
              className="text-accent font-semibold hover:text-accent/80 transition-colors text-sm"
            >
              שליחת פנייה נוספת
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-white/10 border border-white/20 rounded-xl p-3 text-white placeholder:text-white/30 focus:outline-none focus:border-accent"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-white/80 mb-1">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-white/10 border border-white/20 rounded-xl p-3 text-white placeholder:text-white/30 focus:outline-none focus:border-accent resize-y"
            />
          </div>
          <div className="text-center pt-2">
            <button
              type="submit"
              disabled={sending}
              className="bg-accent text-white px-10 py-3 rounded-full font-semibold hover:bg-accent/90 transition-colors disabled:opacity-50 text-lg"
            >
